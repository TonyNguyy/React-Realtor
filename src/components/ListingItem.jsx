        ...
        <Link className="contents" to={`/category/${listing.type}/${id}`}>
            ...
            <div className="w-full p-[10px] ">
                ...
                <div className="flex items-center mt-[10px] space-x-4">
                    <div className="flex items-center space-x-1">
                        <p className="font-bold text-xs">{listing.bedrooms > 1 ? `${listing.bedrooms} Beds` : "1 Bedroom"}</p>
                    </div>
                    <div className="flex items-center space-x-1">
                        <p className="font-bold text-xs">{listing.bathrooms > 1? `${listing.bathrooms} Baths` : "1 Bathroom"}</p>
                    </div>
                </div>
