...
//         const q = query(listingRef, where("type","==", params.categoryName),orderBy("timestramp","desc"),limit(8));
...
//     try {
//       const listingRef = collection(db, "listings")
//       const q = query(listingRef, where("type","==", params.categoryName),orderBy("timestramp","desc"),
